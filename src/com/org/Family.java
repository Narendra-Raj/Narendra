...
public class Family {
	       public static void main(String args[])
	       {
	    	   ...
	    	   Scanner sc= new Scanner(System.in);
	              ...
	              case 1: 
	                     System.out.println("hotel 1 is selected");
	                     ...
	                     break;
	              case 2: 
	                     System.out.println("hotel 2 is selected");
	                     ...
	                     case 1:
	                           ...
	                           if(child1%2==0)
	                           {
	                                  ...
	                                  System.out.println("cost of  rooms = "+(price1=n1*3000));
	                           }
	                           }
	                           if(adult1>2)
	                           {
	                           if(adult1%2==0)
	                           {
	                                  n1=adult1/2;
	                                  System.out.println("Number of rooms ="+n1);
	                                  System.out.println("cost of  rooms = "+(price=n1*3000));
	                           }
	                           }
	                           break;
	                     ...
	                     case 2:
	                           ...
	                           if(child1%2==0)
	                           {
	                                  n=child1/2;
	                                  System.out.println("Number of rooms ="+n);
	                                  System.out.println("cost of  rooms = "+(price1=n*2500));
	                           }
	                           }
	                           if(adult1>2)
	                           {
